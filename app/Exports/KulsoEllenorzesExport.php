...
class KulsoEllenorzesExport implements FromCollection, Responsable, WithStrictNullComparison ,ShouldAutoSize, WithHeadings, WithMapping
{
    use Exportable;

    private $fileName = "kulso_ellenorzesek.xlsx";

    private $writerType = Excel::XLSX;

    public function collection()
    {
        return KulsoEllenorzes::with(["allomasEllSzerv", "allomasFelelosSzervEgyseg", "ellenor"])->get();
    }
