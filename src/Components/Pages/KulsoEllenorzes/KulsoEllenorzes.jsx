...
class KulsoEllenorzes extends Component {
    constructor(props) {
        super(props)
                    ...
                    <Col lg={4} md={6} className="py-2">
                        <Form.Group>
                            ...
                            <Form.Select defaultValue="">
                                <option value="" disabled>Válassza ki az ellenőrzés végzőt!</option>
                                {/*A partnerek listáját az adatbázisba felvitt ellenőrzést végzőkkel gondoltam feltölteni*/}
                                <option value="pelda">Példa Ellenörző Szerv</option>
                            </Form.Select>
                        </Form.Group>
                    </Col>
