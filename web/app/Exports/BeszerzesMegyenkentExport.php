...
class BeszerzesMegyenkentExport  implements FromCollection, Responsable, WithStrictNullComparison, ShouldAutoSize ,WithHeadings, WithMapping
{
    use Exportable;

    private $fileName = 'beszerzesek_megye.xlsx';
    ...
    {   
        return Beszerzes::query()
        ->with(["partner", "allomas"])
        ->join('allomasok', 'beszerzesek.mentoallomas', '=', 'allomasok.nev')
