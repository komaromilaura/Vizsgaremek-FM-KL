...
class AllashelyExport implements FromCollection, Responsable, WithStrictNullComparison ,ShouldAutoSize, WithHeadings, WithMapping
{
    use Exportable;

    private $fileName = "allashely.xlsx";

    private $writerType = Excel::XLSX;
    
    public function collection()
    {
        return Allashely::with("allomas")->get();
    }
