...
class BelsoEllenorzesExport implements FromCollection, Responsable, WithStrictNullComparison ,ShouldAutoSize, WithHeadings, WithMapping
{
    use Exportable;

    private $fileName = "belso_ellenorzesek.xlsx";

    private $writerType = Excel::XLSX;

    public function collection()
    {
        return BelsoEllenorzes::with(["allomasEllSzerv", "allomasFelelosSzervEgyseg"])->get();
    }
