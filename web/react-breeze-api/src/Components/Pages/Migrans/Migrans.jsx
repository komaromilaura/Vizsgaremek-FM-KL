        ...
        <Form className="p-3 min-vh-100">
            ...
            <Row className="py-4">
                <Col lg={12} className="justify-content-center d-flex mb-3">
                    ...
                    <Button variant="info" >
                        <a href="http://localhost:8000/migrans/file-export" className="text-white text-uppercase fw-bold mx-3 text-decoration-none">
                            Adatok exportálása
                        </a>
                    </Button> 
                </Col>
                    ...
                    {megyek && megyek.map((megye) => {
                        return(
                            <Button variant="info" key={megye.ID} className="mx-1">
                                <a href={"http://localhost:8000/migrans/file-export/"+megye.ID} className="text-white text-uppercase fw-bold text-decoration-none">
